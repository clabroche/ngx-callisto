...
MapService.ngInjectableDef = defineInjectable({ factory: function MapService_Factory() { return new MapService(inject(HttpClient)); }, token: MapService, providedIn: "root" });
...
ThemeService.ngInjectableDef = defineInjectable({ factory: function ThemeService_Factory() { return new ThemeService(); }, token: ThemeService, providedIn: "root" });
var mockdataTable = require('./datatable_data.json');
var ThemeManagerComponent = /** @class */ (function () {
    function ThemeManagerComponent(themeService, common) {
