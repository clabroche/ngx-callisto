...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.goTo = function (data) { this.click.emit(data); };
...
SidebarComponent.propDecorators = {
    ...
    "click": [{ type: core.Output, args: ['router',] },],
};
