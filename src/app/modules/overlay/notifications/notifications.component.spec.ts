...
describe('DefiNotificationsComponent', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [
        DefiNotificationsComponent
      ],
      providers: [DefiNotificationsService]      
    }).compileComponents();
  }));
  it('should create the app', async(() => {
    const fixture = TestBed.createComponent(DefiNotificationsComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app).toBeTruthy();
  }));
  it(`should have good properties and dependencies`, async(() => {
    const fixture = TestBed.createComponent(DefiNotificationsComponent);
    const app: DefiNotificationsComponent = fixture.debugElement.componentInstance;
    expect(app.ns instanceof DefiNotificationsService).toBeTruthy();
  }));
  describe('#add', () => {
